...
if(isset($_POST['register']))
{
    ...
    move_uploaded_file($file_tmp,$emp_profile_pic);
	  ...
	  $query="insert into mst_employee (id,emp_name,emp_id,emp_gender,emp_contact_no,emp_emergency_contact_no,emp_date_of_birth,emp_date_of_joining,
      emp_email,emp_address,emp_blood_group,emp_is_login_user,emp_username,emp_password,emp_profile_pic,emp_role_id,emp_designation_id,is_active,is_removed)
       values('','$emp_name','$emp_id','$emp_gender','$emp_contact_no', '$emp_emergency_contact_no', '$emp_date_of_birth', '$emp_date_of_joining', '$emp_email', '$emp_address', 
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control"  type="text" name="emp_id" placeholder="Enter your last name" />
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        ...
                                                        <input class="form-control" type="tel"  name="emp_contact_no" placeholder="123-45-678" pattern="[0-9]{3}[0-9]{2}[0-9]{3}[0-9]{2}" required>
