...
$query="
select count(id) employee_count,
(select count(id) from mst_customers where is_active=true) customer_count,
(select count(id) from mst_diagram where is_active=true) diagram_count,
(select count(id) from mst_route_card where is_active=true) route_card_count
from mst_employee where is_active=true";
...
$monthwise_routecard_query = "select group_concat(res.month_name) month_name, group_concat(total_count) total_count from (
    ...
    from mst_route_card where is_active=true and date_format(created_at,'%Y%m')=date_format(now(),'%Y%m')
    -- date_format(now(),'%Y%m') 
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body"><i class="fa fa-id-badge"></i><h4>Employee  <?php echo $data['employee_count']; ?></h4></div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-secondary text-white mb-4">
                                    <div class="card-body"><h4><i class="fas fa-users"></i><br>Customers <?php echo $data['customer_count']; ?> </h4></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
