...
$comp_view_query='select a.*, b.comp_name from mst_route_card a inner join mst_customers b on b.id=a.route_customer_id where a.id='.$_GET['id'];

       $eqry=mysqli_query($con,$comp_view_query);
    ...
    $diag_view_query='select a.*, b.dia_code from mst_route_card a inner join mst_diagram b on b.id=a.route_diagram_id where a.id='.$_GET['id'];
...
<main>
  ...
  <tr>
  >-----------------------------------An Product of Sri Ram Industries------------------------------------
